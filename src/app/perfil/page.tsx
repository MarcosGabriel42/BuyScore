    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center pt-10 pb-24">
      ...
      <div className="flex flex-col items-center gap-4 w-full max-w-xs">
        ...
        <Link href="/editar-perfil" className="w-full">
          <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white flex items-center justify-center gap-2 rounded-full py-6 text-base">
